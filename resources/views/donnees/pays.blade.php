                            ...
                            <tbody>
                                @foreach($pays as $key => $item)
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('pays.update', ['id' => $item->id]) }}" method="post">
                                                        @csrf
                                                        <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" name="indicatif" type="text" value="{{ old("indicatif")?? $item->indicatif }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="">Dévise</label>
                                                                <select class="form-control" name="devise_id">
                                                                    @foreach ($devises as $devise)
                                                                        <option value="{{ $devise->id }}" {{ $devise->id == $item->devise_id ? 'selected' : '' }}>{{ $devise->libelle }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->devise->libelle }}</td>
                                        <td>
                                            <a class="text-success mr-2" href="#" data-toggle="modal" data-target="#id{{ $item->id }}">
                                                <i class="nav-icon i-Pen-2 font-weight-bold"></i>
                                            </a>
                                            <form action="{{ route('pays.destroy', ['id' => $item->id]) }}" method="POST"  style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                ...
                <div class="card-body">
                    <div class="d-flex flex-column">
                        <form action="{{ route('pays.store') }}" method="post">
                            ...
                            <div class="form-group">
                                <label for="">Indicatif</label>
                                <input class="form-control" name="indicatif" type="text">
                            </div>
                            <div class="form-group">
                                <label for="">Dévise</label>
                                <select class="form-control" name="devise_id">

...
@include('layouts.fileariane')
    ...
    <div class="row">
        ...
        <div class="card text-left">
            <div class="card-body">
                <h4 class="card-title mb-3">Type de publications de livre</h4>
                @if($type_publications->isNotEmpty() )
                    <div class="table-responsive">
                        <table class="display table table-striped table-bordered" id="language_option_table" style="width:100%">
                            ...
                            <tbody>
                                @foreach($type_publications as $key => $item)
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('type-de-publication.update', ['id' => $item->id]) }}" method="post">
                                                        @csrf
                                                        <div class="col-md-12">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('type-de-publication.destroy', ['id' => $item->id]) }}" method="POST"  style="display:inline;">
                                                @csrf
                                                @method('DELETE')
        ...
        <div class="col-lg-4 col-md-12">
            <h4>Ajouter une type de publication de livre</h4>
            <div class="card mb-5">
                <div class="card-body">
                    <div class="d-flex flex-column">
                        <form action="{{ route('type-de-publication.store') }}" method="post">
                            @csrf
                            <div class="form-group">
                                <label for="">Libellé</label>
